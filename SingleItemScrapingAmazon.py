...
# But for efficiency purpose we will just view the data on this interfact
import pandas as pd
df = pd.read_csv(r'/Users/cindyfransisca/Documents/Github/lbai/Projects/Cindy/scraping_amazon/MonsteraPriceTracker.csv')
print(df)